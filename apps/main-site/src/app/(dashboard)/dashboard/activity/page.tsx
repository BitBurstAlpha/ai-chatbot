    ...
    <div className="h-[calc(100vh-64px)] text-white p-6">
      ...
      <div className="flex flex-col items-center justify-center text-center py-20">
        ...
        <p className="text-gray-400 max-w-md mb-6">
          The Activity page is currently under development and will be available
          soon.
        </p>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                This feature will allow you to track all activities performed by
                users and chatbots in your system. Check back later for updates
